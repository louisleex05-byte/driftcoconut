      ...
      <div className="max-w-screen-2xl mx-auto px-3 sm:px-4 h-16 sm:h-20 flex items-center justify-between gap-3">
        ...
        >
          ...
          <span className="flex flex-col min-w-0 leading-none">
            <span className="font-display text-xl sm:text-2xl md:text-3xl font-semibold tracking-tight text-sea-700 truncate mt-2">
              driftcoconut
            </span>
            <span
              className="font-display text-[13px] sm:text-sm md:text-base font-medium tracking-wide text-emerald-400 mt-0 truncate animate-drift"
              lang="th"
