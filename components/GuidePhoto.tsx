...
const GUIDES: Record<string, Record<string, PhotoEntry>> = {
  ...
  chiangrai: {
    hero: { file: "hero.jpg", alt: "Hero photo alt - main destination shot" },
  ...
  chiangrai: {
    hero: { file: "hero.jpg", alt: "Misty sunrise over Chiang Rai’s mountain ridges, with soft northern Thai light and distant forested hills" },
    whenToGo: { file: "when-to-go.jpg", alt: "White Temple under clear cool-season skies, or Songkran water celebrations in Chiang Rai" },
    ...
    localFood: { file: "local-food.jpg", alt: "Khao soi northern Thai curry noodles served with pickled mustard greens and crispy noodles" },
  },
  chiangrai: {
    hero: { file: "hero.jpg", alt: "Misty sunrise over Chiang Rai’s mountain ridges, with soft northern Thai light and distant forested hills" },
    whenToGo: { file: "when-to-go.jpg", alt: "White Temple under clear cool-season skies, or Songkran water celebrations in Chiang Rai" },
  ...
  chiangrai: {
    hero: { file: "hero.jpg", alt: "Misty sunrise over Chiang Rai’s mountain ridges" },
    whenToGo: { file: "when-to-go.jpg", alt: "White Temple under clear cool-season skies" },
    neighborhood1: { file: "neighborhood1.jpg", alt: "Chiang Rai Clock Tower and Night Bazaar streets at dusk" },
    neighborhood2: { file: "neighborhood2.jpg", alt: "Kok River waterfront with a quiet riverside resort and tropical greenery" },
    activity: { file: "activity.jpg", alt: "Wat Rong Khun (White Temple), Chiang Rai’s white mirrored temple complex" },
    localFood: { file: "local-food.jpg", alt: "Khao soi northern Thai curry noodles served with pickled mustard greens and crispy noodles" },
