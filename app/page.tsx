...
export default function HomePage() {
  return (
    <div className="space-y-10 relative">
      ...
      {/* Between-sections decorative strip — small drifting accents */}
      ...
      <section id="deals" className="relative py-6">
        {/* Background accents around the deals block */}
        ...
        <div className="grid md:grid-cols-3 gap-4 relative z-10">
          {[
            ...
            >
              ...
              {/* Faint corner accent — different icon per card */}
      ...
      {/* Below-deals dispersed accents — pebble & coral scattered */}
