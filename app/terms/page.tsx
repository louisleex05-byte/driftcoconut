...
export const metadata: Metadata = {
  title: "Terms of Use — TravelSite",
  description: "Terms for using TravelSite.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto prose prose-slate">
      ...
      <p className="text-slate-600">
        TravelSite is a hotel search and comparison service. We display hotel listings, photos,
      ...
      <p className="text-slate-600">
        Prices and availability shown on TravelSite are provided by our partners and are subject
      ...
      <p className="text-slate-600">
        Hotel photos, descriptions, and reviews displayed on TravelSite are the property of the
      ...
      <p className="text-slate-600">
        TravelSite provides search results "as is." We are not responsible for the quality,
      ...
      <p className="text-slate-600">
        ...
        <a href="mailto:legal@travelsite.example" className="text-brand">legal@travelsite.example</a>.
      </p>
    </div>
  );
}
